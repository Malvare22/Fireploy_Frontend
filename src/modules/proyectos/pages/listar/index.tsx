...
//   const {filterDataFn, filters, handleFilter} = useFilters();
//   const {handleOrder, order, orderDataFn} = useOrderSelect();
...
//                       onChange={(e) =>
//                         handleFilter("estadoDeEjecucion", (x) =>x.estadoDeEjecucion == e.target.value)
//                       }
//                     >
...
//             <Stack spacing={2}>
//               {filterDataFn(orderDataFn(projects)).map((proyecto, key) => (
