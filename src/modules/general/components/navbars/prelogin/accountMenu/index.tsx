      ...
      <React.Fragment>
        <Box sx={{ display: 'flex', alignItems: 'center', textAlign: 'center', gap: 2 }}>
          ...
          {/* <Divider sx={{backgroundColor: 'white', height: '50px', width:2}} orientation='vertical'/> */}
              <Typography variant='body1' fontWeight={'bold'} display={{xs: 'none', md: 'flex'}} width={180} >{localUser?.nombre ?? ''}</Typography>
          <Tooltip title="Account settings">
            ...
            >
              <Avatar sx={{ width: 48, height: 48 }} src={localUser?.foto ?? ''}></Avatar>
            </IconButton>
          </Tooltip>
        </Box>
                <Menu
