  ...
  export const materiasEjemplo: Materia[] = [
    {
      ...
      semestre: "2023-1",
      descripcion: "Curso de matemáticas avanzadas que cubre temas como cálculo multivariable y álgebra lineal. asdjhsdkgjhdfkjghdkf gidj hrijhijdf h gkjdfhngkjdfkjgdhkjhgdkjhgdkjhfgkjdhfgkjdhfgkjhdfkghdfkjhgkdjhgkdjhfgk",
      estado: 'A',
      cursos: [
        {
          id: "101",
    ...
    },
    {
      ...
      semestre: "2023-1",
      descripcion: "Introducción a los principios de la física cuántica y sus aplicaciones.",
      estado: 'A',
      cursos: [
        {
          id: "201",
